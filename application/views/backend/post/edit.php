			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> <input value="<?php echo @$record["Name"];?>" id="Name" class="form-control col-md-7 col-xs-12" name="Name" placeholder="Name " required="required" type="text"> </div>
					</div>

					<div class="item form-group"> 
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="Meta_Tags">Meta Tags</label>
						<div class="col-md-9 col-sm-10 col-xs-12">
							<input value="<?php echo @$record["Meta_Tags"];?>" id="Meta_Tags" class="form-control col-md-7 col-xs-12" name="Meta_Tags" placeholder="Meta Tags" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12">
							<input value="<?php echo @$record["Meta_Description"];?>" id="Meta_Description" class="form-control col-md-7 col-xs-12" name="Meta_Description" placeholder="Meta Description" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<?php echo $this->ckeditor->editor('Disclaimer',@$record["Disclaimer"]);?>
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record["Date"];?>" id="Date" class="form-control col-md-7 col-xs-12" name="Date" placeholder="Date" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record["Author"]; ?>" id="Author" class="form-control col-md-7 col-xs-12" name="Author" placeholder="Author" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record["CTA"]; ?>" id="CTA" class="form-control col-md-7 col-xs-12" name="CTA" placeholder="CTA" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record["Button_Text"]; ?>" id="Button_Text" class="form-control col-md-7 col-xs-12" name="Button_Text" placeholder="Button_Text" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record["Button_Url"]; ?>" id="Button_Url" class="form-control col-md-7 col-xs-12" name="Button_Url" placeholder="Button_Url" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
							<input value="<?php echo @$record['Color']; ?>" id="Color" class="form-control col-md-7 col-xs-12" name="Color" placeholder="Color" type="text">
						</div>
					</div>
					...
					<div class="item form-group"> 
						...
						<div class="col-md-9 col-sm-10 col-xs-12"> 
						    <div class="featured-image <?php echo @$record['Media'] != null ? 'active' : ''; ?>">
		                        ...
		                        <input id="xImagePath" name="Media" value="<?php echo @$record['Media']; ?>" type="text" size="60" class="form-control xImagePath" style="display: none;" />
		                    </div>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-3"><a href="<?php echo backend_url(@$base_controller) . "?post_type=".$post_type;?>" class="btn btn-primary">Back</a><button id="send" type="submit" class="btn btn-success">Save</button> </div>
					</div>
				</form>
			</div>
		</div>
