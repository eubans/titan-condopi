			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
					...
					<div class="item form-group"> 
						...
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="Address" class="form-control col-md-7 col-xs-12" value="<?php echo $record["Address"]?>" name="Address" placeholder="Address" type="text"> </div>
					</div>

					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Country">Country</label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="Country" class="form-control col-md-7 col-xs-12" value="<?php echo $record["Country"]?>" name="Country" placeholder="Country" type="text"> </div>
					</div>

					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="State">State</label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="State" class="form-control col-md-7 col-xs-12" value="<?php echo $record["State"]?>" name="State" placeholder="State" type="text"> </div>
					</div>

					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="City">City</label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="City" class="form-control col-md-7 col-xs-12" value="<?php echo $record["City"]?>" name="City" placeholder="City" type="text"> </div>
					</div>

					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Zipcode">Zipcode</label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="Zipcode" class="form-control col-md-7 col-xs-12" value="<?php echo $record["Zipcode"]?>" name="Zipcode" placeholder="Zipcode" type="text"> </div>
					</div>
