		...
		<div class="x_panel">
			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Content</label>
                        <textarea rows="10" name="Content" class="form-control"><?php echo $this->input->post("Content")?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Sort</label>
                        <input type="number" name="Sort" class="form-control" value="<?php echo $this->input->post("Sort")?>">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <?php 
