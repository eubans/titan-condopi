			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post">
					<div class="item form-group"> 
						...
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="Role_Title" class="form-control col-md-7 col-xs-12" value="<?php echo @$record["Role_Title"];?>" name="Role_Title" placeholder="Role Name" required="required" type="text"> </div>
					</div>
					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Role_Description">Description</label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input id="Role_Description" class="form-control col-md-7 col-xs-12" value="<?php echo @$record["Role_Description"];?>" name="Role_Description" placeholder="Description" type="text"> </div>
					</div>
