			...
			<div class="x_content">
				...
				<form class="form-horizontal form-label-left" method="post" action="">
					<div class="item form-group"> 
						...
						<div class="col-md-6 col-sm-6 col-xs-12"> <input value="<?php echo @$record['Module_Name'];?>" id="Module_Name" class="form-control col-md-7 col-xs-12" name="Module_Name" placeholder="Name System" required="required" type="text"> </div>
					</div>
					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Module_Key">Identifier System*<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input value="<?php echo @$record['Module_Key'];?>" id="Module_Key" class="form-control col-md-7 col-xs-12" name="Module_Key" placeholder="Identifier System*" required="required" type="text"> </div>
					</div>
					<div class="item form-group"> 
						<label class="control-label col-md-3 col-sm-3 col-xs-12" for="Module_Url">Path<span class="required">*</span></label>
						<div class="col-md-6 col-sm-6 col-xs-12"> <input value="<?php echo @$record['Module_Url'];?>" id="Module_Url" class="form-control col-md-7 col-xs-12" name="Module_Url" placeholder="Path" required="required" type="text"> </div>
					</div>
					<div class="item form-group"> 
					...
					<div class="item form-group"> 
						...
						<div class="col-md-6 col-sm-6 col-xs-12"> <input value="<?php echo @$record['Order'];?>" id="Order" class="form-control col-md-7 col-xs-12" name="Order" placeholder="Order" type="number"> </div>
					</div>	
					<div class="item form-group"> 
							...
							<select id="Status" class="form-control col-md-7 col-xs-12" name="Status">
							    <?php if(@$record["Status"] == "1"){?>
							   	...
							   	<?php }else{ ?>
								    ...
								    <option value="0" selected="">Shut down</option>
							   	<?php }?>
