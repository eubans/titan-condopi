	...
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<div class="row">
					<div class="col-md-5">
				    	<h2>Management Page/Block <a class="btn btn-success create-item" href="<?php echo backend_url(@$base_controller."/create");?>"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add new</a></h2>
				    </div>
					<div class="col-md-4">
			                            ...
			                            <div class="dropdown-menu dropdown-menu-right" role="menu">
			                                <form class="form-horizontal" id="search-form" role="form">
			                                  ...
			                                  <div class="form-group">
			                                    <label for="filter">Type Page</label>
						...
						<table class="table table-striped jambo_table bulk_action">
							<thead>
								<tr class="headings">
									...
									<th class="column-title">Type Page</th>
							        ...
							        if (isset($table_data)) {
							        	...
							        	foreach ($table_data as $key => $value) {?>
								    		<tr class="even pointer">
												...
												<td class=" "><?php echo $value["Key_Identify"]; ?></td>
												<td class=" "><?php echo $value["Type_Page"]; ?></td>
