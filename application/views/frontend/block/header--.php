...
<head>
    ...
    <?php 
    	$config_site = $this->Common_model->get_record("Web_Setting",["id" => 1]) ; 
    	$BODY_JSON = json_decode(@$config_site['Body_Json'],true); 
    ?>
    <title><?php echo @$BODY_JSON['Meta_Title']; ?></title>
	<meta content="Off-Market, FSBO, Estate" name="keywords" />
	<meta content="The leading marketplace for off-market properties in Los Angeles. Shop for free, list for free, keep all of the commission." name="description" />
    <!-- Bootstrap -->
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll logo" href="<?php echo base_url(); ?>"><img alt="Condo PI" src="<?php echo base_url("skins/frontend/images/logo.png"); ?>"></a>
            </div>
	    ...
	    <section class="section banner-section">
		    <div class="blok-search">
		        <div class="main-blok-search">
					<?php if (isset($error404) && $error404) : ?>
						<h2 class="text-center libre-franklin-medium"><span style="color: #f12a53; font-weight: bold;">We're sorry</span><br/>that page can't be found</h2>
						<p style="margin-bottom: -20px;margin-top: 30px;font-size: 14px;">But you can still find great off-market deals by searching below or heading <span style="color: #f12a53;">home</span></p>
					<?php else : ?>
			            ...
			            <div class="next-items">
			                <ul>
			                    <li class="futura-pt-demi font-s-20"><a href="/?listingtype=FSBO,REO%20(for%20Lenders%20only),Corporate%20Owned,Pocket%20Listing%20(for%20Licensed%20Agents%20only),Probate,Auction%20(for%20Auctions%20only),Contract%20Sale%20(for%20Wholesalers%20only),Other">OFF-MARKET</a></li>
			                    <li class="futura-pt-demi font-s-20"><a href="/?listingtype=REO%20(for%20Lenders%20only)">REO</a></li>
			                    <li class="futura-pt-demi font-s-20"><a href="/?listingtype=Pocket%20Listing%20(for%20Licensed%20Agents%20only)">POCKET LISTINGS</a></li>
			                </ul>
			            </div>
		            <?php endif; ?>
