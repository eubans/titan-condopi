        			...
        			<?php foreach ($testimonials as $key => $item): ?>
                        <div style="margin-left: 15px; margin-right: 15px;">
                            <div class="description">
                                ...
                                <p class="libre-franklin-medium font-s-14 mr-b-20" style="text-align: right;">
...
<footer>
            ...
            <div class="col-md-4 footer-social">
                <div class="row">
                    <div class="col-md-12 mr-b-30">
                        <h2 class="georgia font-s-24 text-uppercase color-646568 mr-b-20"><a href="<?php echo base_url(); ?>"><img alt="Condo PI" src="<?php echo skin_url("/frontend/images/logo.png")?>"></a></h2>
                    </div>
                    <div class="col-md-5 mr-b-30"><a href="tel:626-793-6300" class="libre-franklin-medium font-s-14 color-646568"><i class="fa fa-phone" aria-hidden="true"></i> 626-793-6300</a></div>
                    <div class="col-md-7 mr-b-30"><a href="mail:support@condopi.com" class="libre-franklin-medium font-s-14 color-646568"><i class="fa fa-envelope-o" aria-hidden="true"></i> support@condopi.com</a></div>
                    <div class="col-md-12">
    					<div class="row">
                    		<div class="col-md-4 mr-b-30 hidden-xs"><span class="libre-franklin-medium font-s-14 color-646568">Follow us on: </span></div>
	                        <div class="col-md-8 mr-b-30">
    ...
    <div class="container-fluid copyright">
        <div class="row">
    		<div class="col-md-12 text-center mr-t-30 mr-b-20 color-646568"><p>© condopi  <a class="color-646568" href="<?php echo base_url('page/term-of-user'); ?>">Terms</a>  <a class="color-646568" href="<?php echo base_url('page/privacy'); ?>">Privacy</a></p></div>
    	</div>
    </div>
</footer>
