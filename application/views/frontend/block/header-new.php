		    ...
		    <div class="blok-search">
		        <div class="container">
		            ...
		            <div class="buyer-seller">
		            	<button class="btn btn-buyer-guide">Buyer</button>
		            	<button class="btn btn-seller-guide">Seller</button>
		            	
		            	<div class="row fivecolumns">
		            		<div class="col-sm-2">
		            			<b>Step 1</b>
		            			<p>Search for the latest off-market deals in your area. </p>
		            		</div>
		            		<div class="col-sm-2">
		            			<b>Step 2</b>
		            			<p>Research property by downloading your Free Property Report. </p>
		            		</div>
		            		<div class="col-sm-2">
		            			<b>Step 3</b>
		            			<p>Keep tabs on your properties using My Analysis. </p>
		            		</div>
		            		<div class="col-sm-2">
		            			<b>Step 4</b>
		            			<p>Select Buy Now to accept Sellers price, or make an Offer. </p>
		            		</div>
		            		<div class="col-sm-2">
		            			<b>Step 5</b>
		            			<p>Get Fast Funding through our Affiliated Lenders. </p>
		            		</div>
		            	</div>
		            </div>
		            ...
		            */ ?>
		            <form class="main-blok-search banner-search" action="">
