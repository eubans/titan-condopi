                            ...
                            <div class="hereimage-review">
                                <?php if(isset($product['HeroImage']) && $product['HeroImage'] != null): ?>
                            		<div style="float:left;position: relative;">
                                        <a href="javascript:;" onclick="$(this).parent().remove();$('#heroimage_remove').val('');" style="position: absolute;color: #ff0000;right: 15px;top: 10px;"><i class="fa fa-times" aria-hidden="true"></i></a>
                                        <img src="<?php echo $product['HeroImage']; ?>" style="height:100px;width:auto;margin-top:10px;margin-right:10px;">
                                        <input type="hidden" name="heroimage_remove" id="heroimage_remove" value="<?php echo $product['HeroImage']; ?>">
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div><br clear="all" />
			...
			<div class="form-group">
                            ...
                            <select class="form-control required" name="Status">
                                ...
                                <?php foreach ($status as $key => $value) {
                                    if(trim($product["Status"]) == trim($key))
