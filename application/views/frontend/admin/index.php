            ...
            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="user_phone" class="col-sm-3 control-label">License Number <i class="fa fa-lock" aria-hidden="true"></i></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?php echo @$user['Estate_License']; ?>" id="estate_license" name="estate_license" required>
                            </div>
                        </div>
                        <div class="form-group">
